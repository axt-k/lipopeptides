...
with tempfile.TemporaryDirectory() as temp_dir:
    ...
    ml_aromaticity_model = unpickle_model("ml_model_pkl/ml_aromaticity.pkl")
    ml_hydroxylation_model = unpickle_model("ml_model_pkl/ml_hydroxylation.pkl")
    ml_length_model = unpickle_model("ml_model_pkl/ml_length.pkl")
